...
public class ResponderQuestao extends javax.swing.JFrame {
    ...
    public void atualizaDados() {
        ...
        try {
            ...
            out.println("DADOS_RESP_QUESTAO     " + quest);

            while (!out.equals("")) {
                String input = in.nextLine();
                if (input.substring(0, 12).equals("PROX_QUESTAO")) {
                    ...
                    String pergunta = input.substring(12, primeira);
            ...
            for (Questoes c : questao) {//COMECA COMO NUM_QUEST=1(PRIMEIRA CHAMADA APOS INSERIR O PIN) E A CADA QUESTAO RESPONDIDA ACRESCENTA 1 A NUM_QUEST E VAI PEGANDO OS ATRIBUTOS DA QUESTAO CORRENTE
                if (i == num_quest - 1) {
    ...
    public void fechartela() {//SE ACABOU O TEMPO E O ALUNO NAO RESPONDEU A QUESTAO---->ERRROUU
        ...
        Errou mc = new Errou(login, quest, num, num_quest, qc, qe,materia,1);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1600, 899));
        setResizable(false);
